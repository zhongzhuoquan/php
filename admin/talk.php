...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="table" >
    ...
    <tr>
        ...
        <td width="25%" align="center" bgcolor="#FFFFFF">书本ID</td>
        <td width="25%" align="center" bgcolor="#FFFFFF">留言</td>
    ...
    while ($row=mysql_fetch_array($result)) {
        ...
        <tr>
            ...
            <td width="6%" height="35" align="center" bgcolor="#FFFFFF"><?=$row['book_id']?></td>
            <td width="6%" height="35" align="center" bgcolor="#FFFFFF"><?=$row['talk']?></td>
            <td width="25%" align="center" bgcolor="#FFFFFF"><a href="deltalk.php?id=<?=$row['id']?>">删除留言</a></td>
        </tr>
